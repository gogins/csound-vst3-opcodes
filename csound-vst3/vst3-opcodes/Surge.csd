...
connect "Surge_Output", "outleft", "Master_Output", "inleft"
connect "Surge_Output", "outright", "Master_Output", "inright"
connect "Piano_Output", "outleft", "Master_Output", "inleft"
connect "Piano_Output", "outright", "Master_Output", "inright"

alwayson "Surge_Output"
alwayson "Piano_Output"
alwayson "Master_Output"

gi_vst3_handle_Surge vst3init "/usr/lib/vst3/Surge.vst3", "Surge", 1
vst3info gi_vst3_handle_Surge
...
gi_plugins[] init 5
gi_plugins[3] init gi_vst3_handle_Surge
...
instr Surge
i_note_id vst3note gi_vst3_handle_Surge, 0, p4, p5, p3
prints "%-24.24s i %9.4f t %9.4f d %9.4f k %9.4f v %9.4f p %9.4f #%3d\n", nstrstr(p1), p1, p2, p3, p4, p5, p7, active(p1)
endin
...
a_in_left init 0
a_in_right init 0
a_out_left, a_out_right vst3audio gi_vst3_handle_Surge, a_in_left, a_in_right
outleta "outleft", a_out_left
outleta "outright", a_out_right
prints "%-24.24s i %9.4f t %9.4f d %9.4f k %9.4f v %9.4f p %9.4f #%3d\n", nstrstr(p1), p1, p2, p3, p4, p5, p7, active(p1)
endin
...
prints "%-24.24s i %9.4f t %9.4f d %9.4f target: %3d  loaded: %s #%3d\n", nstrstr(p1), p1, p2, p3, i_target_plugin, S_preset_name, active(p1)
endin
...
i "Param_Change" 10 1 3 6 .1
i "Print_Info" 10.5 1 3
; Restores original filter state.
i "Load_Preset" 12 1 3 "/home/mkg/Documents/Surge/Leads/Butter.fxp"
</CsScore>
</CsoundSynthesizer>
...
connect "Odin2_Output", "outleft", "Master_Output", "inleft"
connect "Odin2_Output", "outright", "Master_Output", "inright"
;connect "Piano_Output", "outleft", "Master_Output", "inleft"
;connect "Piano_Output", "outright", "Master_Output", "inright"

alwayson "Odin2_Output"
alwayson "Piano_Output"
alwayson "Master_Output"

gi_vst3_handle_Odin2 vst3init "/usr/lib/vst3/Odin2.vst3", "Odin2", 1
vst3info gi_vst3_handle_Odin2
...
gi_plugins[] init 5
gi_plugins[3] init gi_vst3_handle_Odin2
...
instr Odin2
i_note_id vst3note gi_vst3_handle_Odin2, 0, p4, p5, p3
prints "%-24.24s i %9.4f t %9.4f d %9.4f k %9.4f v %9.4f p %9.4f #%3d\n", nstrstr(p1), p1, p2, p3, p4, p5, p7, active(p1)
endin
...
a_in_left init 0
a_in_right init 0
a_out_left, a_out_right vst3audio gi_vst3_handle_Odin2, a_in_left, a_in_right
outleta "outleft", a_out_left
outleta "outright", a_out_right
prints "%-24.24s i %9.4f t %9.4f d %9.4f k %9.4f v %9.4f p %9.4f #%3d\n", nstrstr(p1), p1, p2, p3, p4, p5, p7, active(p1)
endin

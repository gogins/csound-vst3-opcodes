...
mkdir -p build-macos
cd build-macos
cmake ../vst3sdk  -DCMAKE_CXX_FLAGS=-I/usr/local/include -DCMAKE_BUILD_TYPE=Debug -DCMAKE_C_FLAGS=-O2 -DSMTG_MYPLUGINS_SRC_PATH:PATH="../csound-vst3" -DCMAKE_OSX_DEPLOYMENT_TARGET=10.15 -GXcode
xcodebuild

...
cd build-macos
cmake ../vst3sdk -DCMAKE_BUILD_TYPE=Debug -DCMAKE_C_FLAGS=-O2 -DCMAKE_CXX_FLAGS=-O2 -DSMTG_MYPLUGINS_SRC_PATH:PATH=${MYPLUGINS_PATH} -DCMAKE_OSX_DEPLOYMENT_TARGET=10.15 -GXcode
xcodebuild

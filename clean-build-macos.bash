...
cmake ../vst3-opcodes -DCMAKE_BUILD_TYPE=RelWithDebInfo -DSMTG_BUILD_UNIVERSAL_BINARY=1 -DCMAKE_C_FLAGS=-O2 -DCMAKE_CXX_FLAGS="-Wno-error=unused-but-set-variable" -DCMAKE_SHARED_LINKER_FLAGS="-framework Foundation" -DCMAKE_EXE_LINKER_FLAGS="-framework Foundation" -DCMAKE_OSX_DEPLOYMENT_TARGET=10.15 -G "Unix Makefiles"

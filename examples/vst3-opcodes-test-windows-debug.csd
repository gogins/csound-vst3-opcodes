...
Assuming you are on Windows, have installed Csound, ahd have unzipped the 
csound-vst3-windows.zip file into a new empty directory, then things are set up
to run this piece from the `csound-vst3/vst3-opcodes` subdirectory.

This piece will only run if the debug versions of the Microsoft C/C++ libraries 
are available on the computer.

</CsLicense>
<CsOptions>
-m195 --opcode-lib="../../build-windows-debug/lib/Debug/vst3_plugins.dll" -z1
</CsOptions>
<CsInstruments>
...
gi_vst3_handle_jx10 vst3init "../../build-windows-debug/VST3/Debug/mda-vst3.vst3", "mda JX10", 1
vst3info gi_vst3_handle_jx10

gi_vst3_handle_piano vst3init "../../build-windows-debug/VST3/Debug/mda-vst3.vst3", "mda Piano", 1
vst3info gi_vst3_handle_piano

gi_vst3_handle_delay vst3init "../../build--windows-debug/VST3/Debug/mda-vst3.vst3", "mda Delay", 1
vst3info gi_vst3_handle_delay

gi_vst3_handle_ambience vst3init "../../build--windows-debug/VST3/Debug/mda-vst3.vst3", "mda Ambience", 1
